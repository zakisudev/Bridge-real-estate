...
import { updateProperty } from "../redux/properties/propertyActions";
...
const UpdateProperty = () => {
  ...
  const [formData, setFormData] = useState<PropertyModel>({
    ...
    regularPrice: property?.regularPrice || 500,
    discountedPrice: property?.discountedPrice || 0,
    ...
    try {
      ...
      try {
        ...
        if (!loading && !error) {
          ...
          reset();
          navigate(`/prop/${property?.id}`);
        } else {
          setPropertyError("Error updating Property, try again");
        }
      } catch (error) {
        console.error(error);
        setPropertyError("Error updating Property, try again");
        ...
        >
          ...
          <div className="flex flex-col justify-start items-center w-1/2 h-fit mt-2">
            ...
            <div className="flex mt-5">
              ...
              >
                {PropertyLoading ? "Updating..." : "Update Property"}
              </button>
            </div>
          </div>
        </form>
